...
public class DiscoveryAccessStatusFulltextRestControllerIT extends AbstractControllerIntegrationTest {
    ...
    public void discoverSearchObjectsTestWithContentInABitstream() throws Exception {
        ...
        getClient().perform(get("/api/discover/search/objects")
            ...
            .andExpect(jsonPath("$._embedded.searchResult._embedded.objects", Matchers.contains(
                SearchResultMatcher.matchOnItemName("item", "items", "Test 1")
            )))
    ...
    @Test
    public void discoverSearchObjectsTestWithTitleAndContentCommonInAPrivateBitstreamAnonymous() throws Exception {
        // ** GIVEN **
        setupItemWithPrivateBitstream();
    ...
    public void discoverSearchObjectsTestWithContentInAnEmbargoedBitstreamAnonymous() throws Exception {
        ...
        //With a size 2
        getClient().perform(get("/api/discover/search/objects")
                .param("query", "DummyEmbargoedText"))
    ...
    @Test
    public void discoverSearchObjectsTestWithTitleAndContentCommonInAnEmbargoedBitstreamAnonymous() throws Exception {
        //** GIVEN **
        setupItemWithEmbargoedBitstream();

        //** WHEN **
        //An anonymous user browses this endpoint to find the objects in the system
        //Test is in the item title and the embargoed bitstream text
        getClient().perform(get("/api/discover/search/objects")
                .param("query", "Test"))
    ...
    @Test
    public void discoverSearchObjectsTestWithContentInAnEmbargoedBitstreamAuthenticatedNoAccess() throws Exception {
        //** GIVEN **
        setupItemWithEmbargoedBitstream();
        String epersonToken = getAuthToken(eperson.getEmail(), password);
    ...
    @Test
    public void discoverSearchObjectsTestWithContentInAnEmbargoedBitstreamAuthenticatedAccess() throws Exception {
        //** GIVEN **
        setupItemWithEmbargoedBitstream(eperson);
        String epersonToken = getAuthToken(eperson.getEmail(), password);
    ...
    private void setupItemWithPrivateBitstream(EPerson groupMember) throws Exception {
        ...
        String bitstreamContent = "ThisIsSomeTestDummyPrivateText";
    ...
    private void setupItemWithEmbargoedBitstream() throws Exception {
        setupItemWithEmbargoedBitstream(null);
    }

    private void setupItemWithEmbargoedBitstream(EPerson groupMember) throws Exception {
        context.turnOffAuthorisationSystem();
        ...
        String bitstreamContent = "ThisIsSomeTestDummyEmbargoedText";

        //Add this bitstream with an embargo set for anonymous group
        try (InputStream is = IOUtils.toInputStream(bitstreamContent, CharEncoding.UTF_8)) {
            BitstreamBuilder bitstreamBuilder = BitstreamBuilder.
                createBitstream(context, publicItem1, is)
                .withName("Bitstream")
                .withDescription("Test Private Bitstream")
                .withMimeType("text/plain")
            ...
            if (groupMember != null) {
                Group internalGroup = GroupBuilder.createGroup(context)
                    ...
                    .build();
                bitstreamBuilder.withReaderGroup(internalGroup);
            }
